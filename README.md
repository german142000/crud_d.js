# Документация по библиотеке `crud_d.js`

`crud_d` — надстройка над библиотекой `dom.js` для быстрого создания модальных диалогов с CRUD-функциональностью (Create, Read, Update, Delete).  
